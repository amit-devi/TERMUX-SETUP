...
# SCRIPT MAKED BY WHITEDEVIL-21
# PYTHON VERSION : 3.11
# GITHUB : WHITEDEVIL-21
# TEAM : AMIT DEVI
...
sys.stdout.write('\x1b]2; WHITEDEVIL-21(AMIT DEVI)\x07')
...
def menu():
    clear()
    os.system('xdg-open https://github.com/WHITEDEVIL-21(AMIT DEVI)')
    clear()
    ...
    elif option in ['2','02','B','b']:clear();os.system('rm -rf OP-BANNER && git clone https://github.com/WHITEDEVIL-21(AMIT DEVI)/OP-BANNER.git && cd OP-BANNER && python2 Banner1.py')
...
def admin():
    ...
    elif option in ['4','04','D','d']:os.system('xdg-open https://github.com/WHITEDEVIL-21(AMIT DEVI)');menu()
